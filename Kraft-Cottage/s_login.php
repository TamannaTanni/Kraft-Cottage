	...
	<div class="container">
		<div class="header_top">
          ...
          <li><a href="signuplogout.php">Register an Account</a></li>
					...
					<li><a href="s_login.php">Login Please</a></li>
				</ul>
			</div>
      <div class="top_left">
...
<form action="checklogin2.php" method="post">
  <center><h2>New Seller <a style="color:red;" href="signuplogout.php">CLICK HERE</a> to Register first.</h2></center><br>
  <center><h2>Existing Seller Login Below</h2></center>
  <br>
  <fieldset>
    <label for="name"><h3>Username:</h3></label>
    <input type="text" id="name" name="suser_name" >

    <label for="passw"><h3>Password:</h3></label>
    <input type="password" id="passw" name="suser_password" >
