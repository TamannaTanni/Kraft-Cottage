...
<div class="header_bg">
  ...
  if (isset($_POST['p_name']) && isset($_POST['p_image']) && isset($_POST['p_price']))
				{
          $pname = $_POST['p_name'];
          ...
          if(isset($_SESSION['sid'])){
						...
						$sql = "Insert into products (p_name,p_image,p_price,p_type,p_raw,p_brand,p_date,p_des,p_sid) values  ('$pname','$pimage','$pprice','$ptype','$praw','$pbrand','$pdate','$pdes','$psid')";
						$result = mysqli_query($conn,$sql) or mysqli_error($conn);
            echo '<center><strong>Product successfully Uploaded</strong></center><br>';
            echo '<center><h1><a href="person1.php">Click here to see your products</a></h1></center>';
				}
      }
				?>
	</div>
