			...
			<div class="products-grids">
				<div class="col-md-8 products-grid-left">
					...
					if(isset($_GET['filter_price']))
					{
						...
						if($price == 0)
						$sql = " SELECT * FROM products WHERE p_type LIKE 'Jewelleries'";
						if($price == 1)
						$sql = " SELECT * FROM products WHERE p_price < 500 AND p_type LIKE 'Jewelleries'";
            if($price == 2)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 500 AND 1000 AND p_type LIKE 'Jewelleries'";
						if($price == 3)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 1000 AND 2000 AND p_type LIKE 'Jewelleries'";
            if($price == 4)
						$sql = " SELECT * FROM products WHERE p_price > 2000 AND p_type LIKE 'Jewelleries'";
				...
				<div class="col-md-4 products-grid-right">
					<div class="w_sidebar">
						<div class="w_nav1">
							...
							<ul>
								<li><a href="cat.php">Categorys</a>
  									<li><a href="cat.php">Furnitures</a></li>
  									<li><a href="catj.php">Jewelleries</a></li>
                    <li><a href="catsh.php">Showpieces</a></li>
  									<li><a href="catp.php">Paintings</a></li>
  									<li><a href="catt.php">Toys</a></li>
  									<li><a href="catn.php">Nakshi Katha</a></li>
                </li>
							</ul>
						</div>
