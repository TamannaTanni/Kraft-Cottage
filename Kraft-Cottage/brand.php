			...
			<div class="products-grids">
				<div class="col-md-8 products-grid-left">
					...
					if(isset($_GET['filter_price']))
					{
						...
						if($price == 0)
						$sql = " SELECT * FROM products WHERE p_brand LIKE 'Shankhochill'";
						if($price == 1)
						$sql = " SELECT * FROM products WHERE p_price < 500 AND p_brand LIKE 'Shankhochill'";
            if($price == 2)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 500 AND 1000 AND p_brand LIKE 'Shankhochill'";
						if($price == 3)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 1000 AND 2000 AND p_brand LIKE 'Shankhochill'";
            if($price == 4)
						$sql = " SELECT * FROM products WHERE p_price > 2000 AND p_brand LIKE 'Shankhochill'";
             ...
             if (!$conn) {
                  ...
                  <h4>'.$row["p_date"].'</h4>
                  <p><a class="item_add" hhref="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><span class=" item_price valsa">$. '.$row["p_price"].' TK .</span><img src="images/cartadd.png"></img> </a></p>
                  <div class="pro-grd">
						...
						<div class="w_nav1">
							...
							<ul>
								<li><a href="brand.php">Brands</a>
  									<li><a href="brand.php">Shankhochill</a></li>
  									<li><a href="bar.php">Arong</a></li>
                    <li><a href="bt.php">Tilottoma</a></li>
  									<li><a href="bg.php">Galaxy</a></li>
  									<li><a href="bc.php">Chorui</a></li>
  									<li><a href="baa.php">Aaka</a></li>
                    <li><a href="bs.php">Shatkahon</a></li>
                    <li><a href="bd.php">Dreamworld</a></li>
                    <li><a href="be.php">Ecstasy</a></li>
                </li>
							</ul>
						</div>
