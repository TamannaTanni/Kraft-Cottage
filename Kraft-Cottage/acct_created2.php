		...
		<div class="header_top">
			<div class="top_right">
				<ul>
					...
					<li><a href="s_login.php">Log In</a></li>
				</ul>
			</div>
			<div class="top_left">
...
<div class="header_bg">
   <div class="container">
	...
	{
		$susername = $_POST['s_name'];
		$semail = $_POST['s_email'];
		$spassword = $_POST['s_password'];
		$smobile = $_POST['s_mobile'];
    $saddress = $_POST['s_address'];
		$sresult = mysqli_query($conn,"SELECT susername,smobile,semail FROM susers WHERE (susername='$susername' OR smobile='$smobile' OR semail='$semail')");
		if ($sresult && mysqli_num_rows($sresult) > 0)
		{
				...
				{
						$sql = "Insert into susers (susername,spassword,smobile,semail,sadd) values  ('$susername','$spassword','$smobile','$semail','$saddress')";
						$sresult = mysqli_query($conn,$sql) or mysqli_error($conn);
						echo '<center><strong>User successfully created</strong></center><br>';
						echo '<center><h1><a href="s_login.php">Click here to Login</a></h1></center>';
				}
				}
				?>
	</div>
