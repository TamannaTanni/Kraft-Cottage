...
<?php
    ...
    $sql = "Insert into orders (p_id,fullname,address,pincode,city,state,mobile,uid) values  ('$pid','$name','$add','$pin','$citi','$stat','$mob','$uid')";
		...
		$sql = "Delete from cart where c_p_id = $pid AND c_u_id = $id";
				...
				echo '<br><h1><center>Go Back To -> <a href="raw.php">Raw Materials</a> / <a href="cat.php">Category</a> / <a href="brand.php">Brand</a>  /  <a href="cart.php">Go To Cart</a></center></h1>';
	}
}
?>
</div>
    ...
    <div class="container">
        <h3 class="tittle">Related Product</h3>
        <div class="products">
         <div class="container">
           <div class="products-grids">
             <div class="products-grid-left">
               ...
               include 'connection.php';
               {
                 $sql = " SELECT * FROM products WHERE p_date between '2019-07-01' AND '2019-07-10'";
                 if (!$conn) {
