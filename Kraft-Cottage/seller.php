		...
		<div class="header_top">
			<div class="top_right">
				<ul>
					...
					<li><a href="ques1.php">Login Please</a></li>
				</ul>
			</div>
      <div class="top_left">
...
<div class="header_bg">
   <div class="container">
	...
	<div class="products">
<form action="acct_created2.php" method="post">
  <h1>Sign Up</h1>
  <fieldset>
    <label for="name">Name:</label>
    <input type="text" id="name" pattern="[a-zA-Z]+" name="s_name" require title="Only alphabets allowed">
    <label for="mail">Email:</label>
    <input type="email" id="mail" name="s_email">
    <label for="passw">Password:</label>
    <input type="password" id="passw" name="s_password" pattern=".{5,10}" require title="Password: 6 to 9 chars">
	  <label for="passw">Mobile:</label>
    <input type="tel" pattern="[\+]\d{13}" id="mobile" name="s_mobile" require title="Format: +88XXXXXXXXXXX" value="+88">
    <label for="address">Address:</label>
    <input type="text" id="address" name="s_address">
