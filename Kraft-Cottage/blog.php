...
<div class="products">
  <center>
            ...
            <li class="active"><a href="nakshiblog.php"><h4>nakshi Kantha</h4></a></li>
            <li class="active"><a href="#"><h4>Diy Candles</h4></a></li>
            <li class="active"><a href="#"><h4>Waste recycling</h4></a></li>
            </ul>
          </center>
        </div>
