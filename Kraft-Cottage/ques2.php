	...
	<div class="container">
		<div class="header_top">
          ...
          <li><a href="#">Welcome -- Guest</a></li>
			...
			<div class="top_left">
        <span class="top_right"> <a class="header_top" style ="color:white;" href="login.php">Feedback .</style></a> | Call us : +8801*********</span>
			</div>
...
<div class="products">
  <center><h2>Wanna upload Your product?<br>Then <a style="color:red;" href="sellup.php"> click here</a><br>Or<br>See <a style="color:red;" href="person1.php">Your Uploaded product</a></h2></center><br>
</div>
